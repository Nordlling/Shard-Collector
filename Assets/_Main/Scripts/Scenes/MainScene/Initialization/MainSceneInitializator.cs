...
{
    public class MainSceneInitializator : IInitializable
    {
        private readonly IGameStateMachine _gameStateMachine;
        private readonly List<IExitableState> _states;

        public MainSceneInitializator(IGameStateMachine gameStateMachine, List<IExitableState> states)
        {
        ...
        public void Initialize()
        {
            ...
            _gameStateMachine.Enter<StartMainSceneState>();
        }
    }
}